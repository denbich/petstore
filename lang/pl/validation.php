...
return [
    ...
    'base64'               => 'Pole :attribute musi być prawidłowym obrazem',
    ...
    'custom'               => [
        ...
        'g-recaptcha-response' => [
            'required' => 'Proszę sprawdzić, czy nie jesteś robotem.',
            'captcha' => 'Błąd Captcha! Spróbuj ponownie później lub skontaktuj się z administratorem witryny.',
        ],
        'google' => [
            'notfound' => 'Nie znaleziono konta połączonego z tym kontem Google.',
            'error' => 'Błąd Google! Spróbuj ponownie później lub skontaktuj się z administratorem witryny.',
        ],
        'facebook' => [
            'notfound' => 'Nie znaleziono konta połączonego z tym kontem facebook.',
            'error' => 'Błąd Facebook! Spróbuj ponownie później lub skontaktuj się z administratorem witryny.',
        ],
        'email2fa' => [
            'expired' => 'Kod wygasł! Wysłaliśmy nowy na maila.',
            'wrong' => 'Kod jest nieprawidłowy!',
        ],
        'prizecodes' => 'Liczba sztuk i wprowadzonych kodów nie jest taka sama.',
    ],
    'attributes'           => [
        'name' => 'imię',
        'email' => 'nazwisko',
