  ...
  <section class="mt-5">
    <div class="container h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-xl-9">
          <h1 class=" mb-4">@lang('Zaloguj się')</h1>
            ...
            <div class="card-body">
              <form action="{{ route('login') }}" method="post">
                @csrf
                  ...
                  <hr class="mx-n3">
                  <div class="px-5 py-4">
                    <button type="submit" class="btn btn-primary btn-lg">@lang('Zaloguj się')</button>
                    <p class="my-2">@lang('Nie masz konta?')</p>
                    <a href="{{ route('register') }}" class="btn btn-outline-primary btn-lg">@lang('Zarejestruj się')</a>
                  </div>
              </form>
            </div>
          </div>
